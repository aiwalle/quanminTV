...
- (void)letGo {
    ...
    [[rootVC currentNavigationController] pushViewController:[[LJADViewController alloc] init] animated:YES];
...
- (void)setupSubviews:(UIWindow*)window {
    ...
    imageView.image = [UIImage imageNamed:@"app_start_4"];
